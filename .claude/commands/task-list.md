---
name: task-list
description: Create a detailed task list in Markdown format based on a Product Requirements Document (PRD).
interactive_mode: true

Examples:
- <example>
  Context: User wants to create a task list for a PRD
  user: Let's create a task list for the PRD on user profile editing.
  assistant: Sure! I'll generate a task list based on the PRD. First, let me analyze the requirements and current codebase.
  <commentary>collaboratively creating a task list with the User</commentary>
</example>
---
...
- **Format:** Markdown (`.md`)
- **Location:** `/features/[prd-dir-name]/` (e.g. `/features/user-profile-editing/`)
- **Filename:** `tasks.md`
